...
import { ArrowUpRight, TrendingUpIcon, History, ShieldQuestionMark } from 'lucide-react';
        ...
        <div>
            ...
            <div>
                <div className='flex flex-row flex-wrap gap-3 justify-between'>
                    {/* TOTAL COMPLAINTS */}
                    <button className='text-left' onClick={() => navigate('cityadmin/complaints')}>
            ...
            <div className='p-5 border border-gray-200 shadow-md rounded-2xl'>
                <div className='flex flex-row items-center gap-1'>
                    ...
                    <div>
                        ...
                        <p className='italic text-gray-500 text-sm mb-3'>List of newly submitted complaints</p>
                    </div>
                </div>
                <table className="min-w-full border-collapse">
                    <thead className="border-b-2 border-gray-300">
                        <tr>
                            <th className="text-left text-sm font-semibold text-black uppercase px-2"> Name of Complaints </th>
                    ...
                    <tbody>
                        <tr className="border-b border-gray-300 hover:bg-gray-50 text-sm text-gray-700 my-1">
                            <td className="max-w-[180px] truncate px-2">Complaint Title 1</td>
